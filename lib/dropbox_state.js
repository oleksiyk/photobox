...
DropboxState.prototype._parse = function(delta){
    ...
    _.each(delta.entries, function(entry){
        ...
        if(obj){
            ...
            obj.metadata['modified'] = Date.parse(obj.metadata['modified']);
            obj.metadata['client_mtime'] = Date.parse(obj.metadata['client_mtime']);
        }
...
DropboxState.prototype.metadata = function(root, path){
